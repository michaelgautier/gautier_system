...
class rss_file_manager_feed_article {
  ...
  public:
    ...
    rss_data_feed_article_set get_set(const rss_data_feed_name_spec& feed_name);
    rss_consequence_set save_set(const rss_data_feed_name_spec& feed_name, rss_data_feed_article_set& rss_set);
};
}
#endif
