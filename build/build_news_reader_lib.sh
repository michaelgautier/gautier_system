...
#g++ -std=c++14 -c -fPIC -g -I../lib/news/ -I../lib/news/techconstruct/ -I../lib/visualfunc/formulation/ -I../librss_ui_impl/ -o obj/librssui_mainscreenvisualsbuilder.o ../librss_ui_impl/mainscreenvisualsbuilder.cxx
