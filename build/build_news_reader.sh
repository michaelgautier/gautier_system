...
g++ -lfltk -L./bin -lnews_visualcallable -lrssui_mainscreenheaderbar -lnews_visualcallableproto -lrssui_mainscreengenerator -Wl,-rpath,. -o bin/newsreader obj/newsreader.o 
