...
g++ -lfltk -L./bin -lnews_visualcallable -lrssui_mainscreenheaderbar -lrssui_mainscreenblueprint -lrssui_mainscreengenerator -Wl,-rpath,. -o bin/newsreader obj/newsreader.o 
