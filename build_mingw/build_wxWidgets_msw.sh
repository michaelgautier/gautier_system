mkdir ~/build_shared/wxWidgetsMSWin
...
../configure --prefix=/home/michaelgautier/build_shared/wxWidgetsMSWin --host=x86_64-w64-mingw32 --with-msw --without-opengl --enable-monolithic --disable-shared --disable-precomp-headers --disable-debug_flag --enable-exceptions --enable-stl --enable-std_containers --enable-std_iostreams --enable-std_string --enable-unicode --disable-ftp --disable-http --enable-sockets --disable-ipv6 --enable-ole --disable-arcstream --disable-base64 --enable-cmdline --disable-dialupman --enable-dynlib --enable-dynamicloader --disable-fs_inet --disable-fs_zip --disable-sound --disable-propgrid --disable-ribbon --disable-mediactrl --disable-gstreamer8 --enable-menus --disable-miniframe --enable-tooltips --disable-splines --enable-validators --disable-busyinfo --enable-hotkey --disable-joystick --enable-accessibility --disable-uiactionsim --disable-palette --disable-compat26 --disable-compat28 --enable-iniconf --enable-regkey --enable-dccache --enable-ps-in-msw --enable-ownerdrawn --enable-wxdib
